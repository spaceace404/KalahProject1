...
public class Mancala {
	...
	//static varible, all object share this varible
	 	private static int[] board;

	    private Player turn;
	    private final int STARTING_AMOUNT = 4;

	// enum type  enable a variable to be defined as a defined constat
   		private enum Player {
    ...
    public static void main(String[] args) throws InterruptedException {
    	...
    	System.out.println("  -----------------------");
    	System.out.println("  ----By-Kev-B----");
    	System.out.println();
    	boolean playAgain = true;
    	while (playAgain) {
    	   	Scanner s = new Scanner(System.in);
        	System.out.print("Enter 2 to play two  player game:");
        	if (s.nextLine().contains("2")) {
        		game.reset();
        	}
        	game.printBoard();
	...
	// *****Maybe create a method for AI to play agiant player one??  *******//
	// *****it should returns an integer of the location  ??  I believe*****//
